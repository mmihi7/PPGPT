...
st.sidebar.header("App Title")  # Add app title
st.sidebar.write("App Description")  # Add app description
...
with st.sidebar.expander("Privacy Policy", expanded=False):
    st.write("Your privacy policy details here.")

# Copyright Info
st.sidebar.write("© 2023 Bonga Talk Research")
