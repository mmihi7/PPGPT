...
# AI Prompts
SUMMARY_PROMPT = """
Provide a 1000 character summary of the following document:

{document_text}
"""

HIGHLIGHTS_PROMPT = """
Create a bulleted list of key highlights and their impacts from the following document. 
Provide 5-7 main points, each with a brief explanation of its impact:
